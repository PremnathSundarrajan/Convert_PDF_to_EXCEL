...
const generateCrateSummary = require("./controller/generateCrateSummary");
...
app.post("/generate-crate-summary", upload.single("excel"), generateCrateSummary.generateCrateSummary);
